...
export type CandidateDiscovery = { id: string; name: string; city: string; theme: string; address?: string; neighborhood?: string; factualClaims: string[]; timeSensitiveClaims: string[]; evidence: ResearchEvidence[]; velvetFit?: number; };
