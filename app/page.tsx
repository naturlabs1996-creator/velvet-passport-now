...
const scenarios = {
  ...
  guardian: {
    ...
    recovery: [
      ...
      { time: "+01", duration: "Ready", name: "Help and location panel", detail: "15 · 17 · 18 · 112 · 114" },
    ],
  },
  secret: {
    label: "Surprise me",
...
const scenarioVisuals = {
  ...
  care: { start: "/images/paris-covered-passage.webp", end: "/images/paris-haussmann-evening.webp" },
